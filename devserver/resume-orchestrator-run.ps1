...
# Usage: scripts/resume-orchestrator-run.ps1 -Key <orchestrator-key> [-Model <litellm-model-name>] [-TimeoutSec 600] [-AutoApprove]
#
...
# Reverse of the cf/* entries in scripts/litellm_config.yaml -- maps the raw
...
# sync with the cf/* block of scripts/litellm_config.yaml.
$cfModelReverseMap = @{
