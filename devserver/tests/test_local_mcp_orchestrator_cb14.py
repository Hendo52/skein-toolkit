#!/usr/bin/env python3
"""
Unit tests for the CB-14 fix (AT-1141, 2026-06-12) in scripts/local-mcp.py:
...
Run with: .venv\\Scripts\\python.exe scripts\\tests\\test_local_mcp_orchestrator_cb14.py
(or `python -m unittest scripts.tests.test_local_mcp_orchestrator_cb14` from repo root)
"""
