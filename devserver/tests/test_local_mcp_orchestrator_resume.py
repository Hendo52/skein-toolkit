#!/usr/bin/env python3
"""
Unit tests for the orchestrator resume mechanism in scripts/local-mcp.py
...
Run with: .venv\\Scripts\\python.exe scripts\\tests\\test_local_mcp_orchestrator_resume.py
(or `python -m unittest scripts.tests.test_local_mcp_orchestrator_resume` from repo root)
"""
