#!/usr/bin/env python3
"""
Unit tests for `_run_validator_pass` in scripts/local-mcp.py (CB-8, 2026-06-11).

Run with: .venv\\Scripts\\python.exe scripts\\tests\\test_local_mcp_validator.py
(or `python -m unittest scripts.tests.test_local_mcp_validator` from repo root)
"""
